...
void fssl_sha256_write(fssl_sha256_ctx* ctx, const uint8_t* data, size_t len) {
  fssl_digest_write(ctx, data, len, fssl_sha256_block, FSSL_SHA256_BLOCK_SIZE);
}
...
fssl_wrap_hash_impl(fssl_sha256);
...
const fssl_hash_t fssl_hash_sha256 = {
    ...
    .write_fn = fssl_sha256_write_impl,
    .finish_fn = fssl_sha256_finish_impl,
    .reset_fn = fssl_sha256_init_impl,
};
