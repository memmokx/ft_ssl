...
FSSL_SRC = src/fssl/encoding.c src/fssl/hash.c src/fssl/md5.c src/fssl/sha256.c src/fssl/sha1.c src/fssl/blake2s.c
CLI_SRC = src/cli/app.c src/cli/node.c
MAIN_SRC = src/main.c src/digest.c

TEST_SRC = tests/fssl/test_md5.c tests/fssl/test_sha256.c tests/fssl/test_sha1.c tests/fssl/test_blake2.c
